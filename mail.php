...
$emailSubject               = 'A message from Arsenii.com'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Arsenii.com';                // REQUIRED value. This is used when a name or email is not collected from the website form
